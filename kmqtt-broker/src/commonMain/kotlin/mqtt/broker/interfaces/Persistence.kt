...
interface Persistence {
     ...
     */
    fun getAllRetainedMessages(): Map<String, Pair<mqtt.packets.mqtt.MQTTPublish, String>>
     ...
     * @param clientId ID of the client
     */
    fun persistRetained(message: mqtt.packets.mqtt.MQTTPublish, clientId: String)
